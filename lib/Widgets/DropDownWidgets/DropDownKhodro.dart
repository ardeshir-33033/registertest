...
class DropDownKhodro extends StatefulWidget {
  ApiRegisterModel register = ApiRegisterModel();
  Function(String newVal) onKhodroCallBack;

  DropDownKhodro({this.register, this.onKhodroCallBack});

  @override
  _DropDownKhodroState createState() => _DropDownKhodroState();
}

class _DropDownKhodroState extends State<DropDownKhodro> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (String newValue) {
                          setState(() {
                            ...
                            var sv = RegisterBusiness()
                                .getVehicles()
                                .where((element) => element.name == newValue)
                                .first;
                            widget.register.vehicles = [
                              VehiclePost(
                                vehicleId: sv.id,
                              )
                            ];
